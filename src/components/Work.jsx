...
<p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>Gained practical industry experience 
    by working on innovative technology projects, enhancing skills in software development,
    ...
    <div className="space-y-12">
        {
            workData.map((data,index)=>(
                ...
                transition-all duration-300">
                    ...
                    <p className='text-grap-400 mb-2 '>{data.company}</p>
