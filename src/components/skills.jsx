       ...
       whileInView={{opacity:1, y:0}}
        ...
        >
            ...
            <div className='container mx-auto px-6'>
                <h2 className='text-3xl font-bold text-color mb-4 text-center'>
                    MY 
                    <span className='text-purple'>Skills</span>
                </h2>
                <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>
                A growing collection of technical skills developed through coursework, hands-on projects, internships, and continuous learning in software development and emerging technologies.
                </p>
